...
class DuringPhraseCard extends StatefulWidget {
  String phrase;
  String type;
  ...
  @override
  State<DuringPhraseCard> createState() => _DuringPhraseCardState();
}

class _DuringPhraseCardState extends State<DuringPhraseCard> {
  final String currentModule = DuringOperationPage().module;
  final String currentDiff = DuringAdvancedPage().diff;
