...
class PrePhraseCard extends StatefulWidget {
  String phrase;
  String type;
  ...
  @override
  State<PrePhraseCard> createState() => _PrePhraseCardState();
}

class _PrePhraseCardState extends State<PrePhraseCard> {
  final String currentModule = PreOperationPage().module;
  final String currentDiff = PreAdvancedPage().diff;
